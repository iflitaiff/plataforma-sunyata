<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container">
        <a class="navbar-brand fw-bold" href="<?= BASE_URL ?>/dashboard.php"><?= APP_NAME ?></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-outline-light btn-sm me-2" href="<?= BASE_URL ?>/logout.php" style="border-color: rgba(255,255,255,0.5);">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <?php if (!empty($_SESSION['picture'])): ?>
                            <img src="<?= sanitize_output($_SESSION['picture']) ?>" alt="Avatar" class="rounded-circle me-2" width="32" height="32">
                        <?php endif; ?>
                        <span><?= sanitize_output($_SESSION['name']) ?></span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><h6 class="dropdown-header">
                            <?= sanitize_output($_SESSION['name']) ?><br>
                            <small class="text-muted"><?= sanitize_output($_SESSION['email']) ?></small>
                        </h6></li>
                        <li><hr class="dropdown-divider"></li>
                        <?php if (isset($_SESSION['user']['access_level']) && $_SESSION['user']['access_level'] === 'admin'): ?>
                        ...
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item text-danger" href="<?= BASE_URL ?>/delete-account.php">
