...
main_menu() {
    while true; do
        ...
        echo -e "${BLUE}═══════════════════════════════════════════════════════════════════════${NC}"
        echo ""
        echo "  ${BOLD}1)${NC} 👥 Gerenciamento de Usuários"
        echo "  ${BOLD}2)${NC} 📝 Solicitações de Acesso"
        echo "  ${BOLD}3)${NC} ⚙️  Configurações do Sistema"
        echo "  ${BOLD}4)${NC} 📊 Monitoramento e Logs"
        echo "  ${BOLD}5)${NC} 🔧 Manutenção do Sistema"
        echo ""
        echo "  ${BOLD}9)${NC} 🌐 Abrir portal no navegador"
        echo "  ${BOLD}0)${NC} 🚪 Sair"
        echo ""
        echo -e "${GRAY}═══════════════════════════════════════════════════════════════════════${NC}"
        echo -n "Escolha uma opção: "
